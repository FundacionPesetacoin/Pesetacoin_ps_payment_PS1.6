...
/*
		$mailVars =	array(
			'{pesetacoin_ps_payment_name}' => Configuration::get('PESETACOIN_PS_PAYMENT_NAME'),
			'{pesetacoin_ps_payment_address}' => Configuration::get('PESETACOIN_PS_PAYMENT_ADDRESS'),
			'{pesetacoin_ps_payment_address_html}' => str_replace("\n", '<br />', Configuration::get('PESETACOIN_PS_PAYMENT_ADDRESS')));
*/
